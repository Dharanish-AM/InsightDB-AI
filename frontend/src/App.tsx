...
export function App() {
  ...
  if (loadingUser) {
    return (
      <div className="min-h-screen bg-[#0B0F17] flex items-center justify-center text-indigo-400">
        <div className="flex items-center space-x-3">
          <div className="w-8 h-8 rounded-xl bg-indigo-600 animate-pulse" />
          <span className="text-sm font-medium text-gray-300">Loading InsightDB AI...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#0B0F17] flex flex-col text-gray-100">
      ...
      <footer className="glass-panel border-t border-gray-800/80 py-4 px-6 text-center text-xs text-gray-500">
